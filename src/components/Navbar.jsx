                    ...
                    {loggedInUser ? (
                        <>
                            ...
                            {loggedInUser?.role === 'customer' && (
                                <NavLink to="/" className="text-white hover:text-gray-400 transition duration-200">Customer Panel</NavLink>
                            )}
                            {loggedInUser?.role === 'truckOwner' && (
                                <NavLink to="/" className="text-white hover:text-gray-400 transition duration-200">Truck Owner Panel</NavLink>
                            )}
